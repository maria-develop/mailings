...
urlpatterns = [
    ...
    path('detail/<int:pk>/', cache_page(10)(MailingDetailView.as_view()), name='mailing_detail'),
    ...
    path('', cache_page(10)(HomePageView.as_view()), name='home'),
    ...
    path('recipient/<int:pk>/', cache_page(10)(RecipientDetailView.as_view()), name="recipient_detail"),
